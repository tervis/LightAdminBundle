...
namespace Tervis\Bundle\LightAdminBundle\Command;
 ...
 */
#[AsCommand(
    name: 'make:light-admin:crud',
    description: 'Creates a new LightAdmin CRUD controller class',
)]
class MakeCrudControllerCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->listing([
            ...
            'Read EasyAdmin docs: url', //Read EasyAdmin docs: https://symfony.com/doc/master/bundles/EasyAdminBundle/index.html
        ]);
